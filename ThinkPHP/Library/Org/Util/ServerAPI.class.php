...
class ServerAPI{
	...
	public function create($userId, $groupId, $groupName) {
    	try{
    		...
    		$ret = $this->curl('/group/create.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
	...
	public function sync($userId, $groupInfo) {
    	try{
    		...
    		$ret = $this->curl('/group/sync.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
    			throw new Exception('bad request');
    		return $ret;
	...
	public function refresh($groupId, $groupName) {
    	try{
    		...
    		$ret = $this->curl('/group/refresh.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
    			throw new Exception('bad request');
    		return $ret;
	...
	public function join($userId, $groupId, $groupName) {
    	try{
    		...
    		$ret = $this->curl('/group/join.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
    			throw new Exception('bad request');
    		return $ret;
	...
	public function queryUser($groupId) {
    	try{
    		...
    		$ret = $this->curl('/group/user/query.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
    			throw new Exception('bad request');
    		return $ret;
	...
	public function quit($userId, $groupId) {
    	try{
    		...
    		$ret = $this->curl('/group/quit.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
    			throw new Exception('bad request');
    		return $ret;
	...
	public function addGagUser($userId, $groupId, $minute) {
    	try{
    		...
    		$ret = $this->curl('/group/user/gag/add.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
    			throw new Exception('bad request');
    		return $ret;
	...
	public function lisGagUser($groupId) {
    	try{
    		...
    		$ret = $this->curl('/group/user/gag/list.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
    			throw new Exception('bad request');
    		return $ret;
	...
	public function rollBackGagUser($userId, $groupId) {
    	try{
    		...
    		$ret = $this->curl('/group/user/gag/rollback.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
    			throw new Exception('bad request');
    		return $ret;
	...
	public function dismiss($userId, $groupId) {
    	try{
    		...
    		$ret = $this->curl('/group/dismiss.json',$params,'urlencoded','im','POST');
    		if(empty($ret))
    			throw new Exception('bad request');
    		return $ret;
