...
<div class="page-container">
	...
	<p class="c-black">    <span style="color:#666">金 额：</span><b style="font-size:16px;color:red">&yen;<?php echo ($list['money']); ?></b>元</p>
	<p class="c-black">    <span style="color:#666">类型：</span><?php echo ($list['rtype']); ?></p>
	<p class="c-black">    <span style="color:#666">描述：</span><?php echo ($list['content']); ?></p>
	...
	<ul>
		...
		<?php if(is_array($retData)): foreach($retData as $key=>$v): ?><li>
			...
			<div class="userright">
				<p class="name">姓名：<?php echo ($v['name']); ?>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;职位：<?php echo ($v['zhiwei']); ?></p>
				<p class="content">
				
				<?php echo ($v['content']); ?>
				
				</p>
				<p class="time">回复时间：<?php echo (date('Y-m-d H:i:s',$v['dealtime'])); ?></p>
			</div>	
