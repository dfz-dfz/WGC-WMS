...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th colspan="7" scope="col">材料申购详情</th>
	...
	<p class="c-black">    <span style="color:#666">采购名称：</span><?php echo ($list['c_name']); ?></p>
	<p class="c-black">    <span style="color:#666">采购品牌：</span><?php echo ($list['c_brand']); ?></p>
	<p class="c-black">    <span style="color:#666">采购规格：</span><?php echo ($list['c_size']); ?></p>
	<p class="c-black">    <span style="color:#666">联系电话：</span><?php echo ($list['mobile']); ?></p>
	<p class="c-black">    <span style="color:#666">采购数量：</span><?php echo ($list['num']); ?></p>
	<p class="c-black">    <span style="color:#666">地 址：</span><?php echo ($list['address']); ?></p>
	<p class="c-black">    <span style="color:#666">进度描述：</span><?php echo ($list['ps']); ?></p>
