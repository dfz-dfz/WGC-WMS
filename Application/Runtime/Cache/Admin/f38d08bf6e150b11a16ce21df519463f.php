...
<body>
	...
	<div class="divc2">
		<ul>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li>
			<a href="<?php echo U('Wangpanpc/fileinfo',array('id'=>$info['id']));?>">
				<img src="http://wgc2013.com/themes/mall/jiaju/images/wenjiajia.png"/>
				<p><?php echo ($info['filename']); ?></p>
			</a>
