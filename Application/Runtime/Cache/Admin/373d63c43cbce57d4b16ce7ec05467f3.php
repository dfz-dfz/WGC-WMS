...
<article class="page-container">
	  ...
	  <form class="form form-horizontal" enctype="multipart/form-data" action="<?php echo U('User/user_edit');?>" method="post" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<div style="line-height:30px;">
					<a style="margin-left: 14px;background-color: red;color: #fff;padding: 2px 8px;" href="<?php echo U('User/bianji_photo',array('id'=>$list['user_id']));?>" >更换头像</a>
				</div>
			</div>
		</div>
