...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加用户','member-add.html','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> <span class="r">共有数据：<strong>600</strong> 条</span> </div>-->
	<div class="mt-20">
	...
	<?php if(is_array($jingy)): foreach($jingy as $key=>$v): ?><tr class="text-c">
				<th><input type="checkbox" value="1" name=""></th>
				<th><?php echo ($v['id']); ?></th>
				<th><?php echo ($v['nam']); ?></th>
				<th><?php echo ($v['mobli']); ?></th>
				<th><?php echo ($v['dizhi']); ?></th>
				
				<!--<td>admin@mail.com</td>
				<td class="text-l">北京市 海淀区</td>
				<td>2014-6-11 11:11:42</td>
				-->
			    <!-- <th class="td-status"><span class="label label-success radius">已启用</span></th> -->
				 <!-- <th class="td-manage"><a style="text-decoration:none" onClick="member_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="member_edit('编辑','member-add.html','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="change_password('修改密码','change-password.html','10001','600','270')" href="javascript:;" title="修改密码"><i class="Hui-iconfont">&#xe63f;</i></a> <a style="text-decoration:none" class="ml-5"  onclick="member_del(this,'<?php echo ($v['id']); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></th>  -->
				 <th><a href="<?php echo U('Makeanappointment/del',array('id'=>$v['id']));?>">删除</a></th>
