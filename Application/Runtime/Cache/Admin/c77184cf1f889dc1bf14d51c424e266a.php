...
<div class="page-container">
	<div class="text-c">
		 ...
		 <form action="<?php echo U('Zhaopin/index');?>" method="post" style="margin-top:20px;">
			  <input type="text" style="width:60%;" id="keyword" name="key" class="input-text" value="<?php echo ($key); ?>"/>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr class="text-c">
						<td><?php echo ($v['id']); ?></td>
						<td class="text-c"><u style="cursor:pointer" class="text-primary" title="查看"><a href="javascript:;"><?php echo ($v['user_name']); ?></a></u></td>
						<td><?php echo ($v['zhiwei']); ?></td>
						<td><?php echo ($v['xinzi']); ?></td>
						...
						<td class="f-14 td-manage">
							<a style="text-decoration:none" href="<?php echo U('Zhaopin/del',array('id'=>$v['id']));?>" title="删 除">删 除</a>
