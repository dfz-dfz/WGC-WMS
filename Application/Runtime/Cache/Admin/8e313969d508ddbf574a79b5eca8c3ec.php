...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户列表 <span class="c-gray en">&gt;</span> 推荐用户列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c">
		<?php if($_SESSION['wgcadmininfo']['fenxiaoshang_name'] == '' ): ?><a class="btn btn-primary radius" href="/index.php/Admin/User/userCate">全部</a>
		 ...
		 <form action="<?php echo U('User/tuijian');?>" method="post" style="margin-top:20px;">
