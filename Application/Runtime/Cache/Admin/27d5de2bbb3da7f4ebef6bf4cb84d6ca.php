...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 考勤管理 <span class="c-gray en">&gt;</span> 请假列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<a href="/index.php/Admin/Kaoqing/exportqj" class="btn btn-danger radius">
				 下载请假考勤
			</a> 
		...
		<span class="r" style="margin:0 20px;">
			共有请假数据：<strong><?php echo count($list); ?></strong> 条
		</span> 
