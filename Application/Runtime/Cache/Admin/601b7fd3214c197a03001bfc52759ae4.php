...
<div class="page-container">
	<form action="<?php echo U('Coupons/optionset',array('id'=>$info['id']));?>" method="post" id="form">
		<div class="row cl mt-10">
			<label class="form-label col-xs-4 col-sm-2 f-18">优惠券最低价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text radius size-L" id="min" name="minprice" placeholder="请输入优惠券最低价格" value="<?php echo ($info['minprice']); ?>">
			</div>
		</div>
		<div class="row cl mt-20">
			<label class="form-label col-xs-4 col-sm-2 f-18">优惠券最高价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text radius size-L" id="max" name="maxprice" placeholder="请输入优惠券最高价格" value="<?php echo ($info['maxprice']); ?>">
			</div>
		</div>
		<div class="row cl mt-20">
			<div class="formControls col-xs-8 col-sm-9">
				<input class="btn btn-primary size-L radius" type="button" value="保存设置" onclick="shezhi()">
			</div>
		</div>
	</form>
</div>
