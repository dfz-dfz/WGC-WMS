...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 公装管理 <span class="c-gray en">&gt;</span> 公装列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" id='shuaxin' title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<form action='/index.php/Admin/Workdecoration/getList' method='post' id = 'qiandaosearch' name='qiandaosearch'>
	<div class="text-c">
		...
		<tbody>
			<?php if(is_array($list)): foreach($list as $k=>$row): ?><tr class="text-c">
					...
					<th width="160">
						...
						|
						<a href="/index.php/Admin/Workdecoration/del/id/<?php echo ($row["id"]); ?>">删除</a>
...
function setjieshouren(id){
	var url = '/index.php/Admin/Workdecoration/revlist/id/'+id+'';
...
//回复
/*function huifu(id){
	var url = '/index.php/Admin/Workdecoration/getDetail/id/'+id+'';
...
function huifu(id){
	...
	if(userids == null || userids == undefined || userids == ''){
		...
		var url = '/index.php/Admin/Workdecoration/huifu/id/'+id+'/userid/'+userids+'';
		member_add('回复',url,'','610');
	}
}
//添加项目
