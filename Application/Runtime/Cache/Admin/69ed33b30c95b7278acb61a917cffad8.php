...
<article class="page-container">
	...
	<form class="form form-horizontal" enctype="multipart/form-data" action="/index.php/Admin/Headline/addForms" method="post" id="form-article-add">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">发布城市：</label>
			<div class="formControls col-xs-8 col-sm-9">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<span class="select-box">
					<select name="type" id="type" class="select" >
						...
						<?php if(($_SESSION['wgcadmininfo']['kehu'] == '微工程')): ?><option value="10">机电安装</option>
						...
						<?php elseif(($_SESSION['wgcadmininfo']['kehu'] == '经艺装饰')): ?>
							...
							<option value="52">公司案例</option>
							<option value="53">公司简介</option>
						...
						<?php elseif(($_SESSION['wgcadmininfo']['kehu'] == '材料商')): ?>
							<option value="55">行业资讯</option>
							<option value="56">公司简介</option>
						<?php elseif(($_SESSION['wgcadmininfo']['kehu'] == '馨品装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '鲁班名匠') or ($_SESSION['wgcadmininfo']['kehu'] == '诚拓装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '邦邑购') or ($_SESSION['wgcadmininfo']['kehu'] == '南耀装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '梵象装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '艺信装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '心一装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '小猪装饰')or ($_SESSION['wgcadmininfo']['kehu'] == '发财熊') or ($_SESSION['wgcadmininfo']['kehu'] == '轩怡富') or ($_SESSION['wgcadmininfo']['kehu'] == '万泽装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '联合共设') or ($_SESSION['wgcadmininfo']['kehu'] == '创跃装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '真正装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '立诚装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '壹木装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '海鹏文图') or ($_SESSION['wgcadmininfo']['kehu'] == '雅茗装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '展博装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '品逸广告') or ($_SESSION['wgcadmininfo']['kehu'] == '美轩装饰') or ($_SESSION['wgcadmininfo']['kehu'] == '天然居') or ($_SESSION['wgcadmininfo']['kehu'] == '鸿家伟')): ?>
							<option value="57">行业资讯</option>
							<option value="58">公司简介</option>
							<option value="59">公司案例</option><?php endif; ?>
						<option value="54">猜你喜欢</option>
					 </select>
				</span> 
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="微工程" placeholder="" id="" name="laiyuan">
			</div>
		</div>
...
<!--/_footer /作为公共模版分离出去-->
<script type="text/javascript" src="/Public/admin/lib/PCASClass.js"></script>
<!--请在下方写此页面业务相关的脚本-->
...
$(function(){
	...
	new PCAS("province","city","area","---请选择---","---请选择---","---请选择---");
