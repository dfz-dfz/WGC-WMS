...
<link rel="stylesheet" type="text/css" href="http://www.wgc2013.com/themes/mall/jiaju/css/api.css"/>
<link type="text/css" href="http://www.wgc2013.com/themes/mall/jiaju/styles/default/css/center.css" rel="stylesheet"  />
<link rel="stylesheet" type="text/css" href="http://www.wgc2013.com/themes/mall/jiaju/css/aui.1.0.css"/>
<link rel="stylesheet" href="http://www.wgc2013.com/themes/mall/jiaju/styles/css/tel_list.css">
...
<link type="text/css" href="http://www.wgc2013.com/themes/mall/jiaju/styles/default/css/main.css" rel="stylesheet"  />
<link type="text/css" href="http://www.wgc2013.com/themes/mall/jiaju/styles/css/global.css" rel="stylesheet"  />
...
<link type="text/css" href="http://www.wgc2013.com/themes/mall/jiaju/styles/css/style.css" rel="stylesheet"  />
<script type="text/javascript" src="http://www.wgc2013.com/index.php?act=jslang"></script>
...
<!-- 	 -->
 	...
 	<!-- 右边的内容 -->
 	<div class="container_right" style="width: 100%;border: 1px solid #cacaca;float: right;background-color: #f7f7f7;padding: 0 10px 10px 10px;">
...
<!-- 						<form class="confirm_" action="post" method="">
							...
							<div class="quxiao_tel" style="position: absolute;font-size: 20px;top: -8px;left: 565px;background-color: #9e9e9e;border-radius: 10px;width: 20px;height: 20px;line-height: 20px;">×</div>
 			...
 			<div class="message_list base_info_public" style="position: relative;display:none;left: -16%;width: 115%;">
				...
				<div class="table_lists_share" style="overflow: hidden;margin-top: 10px;min-height: 300px;">
						<div class="search_ys_list_share">
							...
							<label class="search_list" for="search_list_share" style="width: 50px;height: 30px;display:inline-block;position: relative;top: -8px;"><img src="http://www.wgc2013.com/themes/mall/jiaju/images/search_button.jpg" alt="" style="width: 100%;height: 100%;" onclick="shareSearch(sharepage,0)"></label>
...
<script type="text/javascript" src="http://www.wgc2013.com/themes/mall/jiaju/js/JTimer_1.3.js"></script>
<script type="text/javascript">
	(function (){
		caigou_list(1,0);
		messagelist(1,0);
...
function prepage(){
	...
	function UserSearch(){
		...
		if(key_word == ''){
			...
			$.post('http://wgcapp.wgc2013.com/jingyi.php/Home/index/searchMyRelatives', {
				uid : '10000',
				type:'PRIVATE',
				types:'user_list',
	        	keyword : key_word,
