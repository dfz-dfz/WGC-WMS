...
<article class="page-container">
       <?php if(is_array($bianji)): foreach($bianji as $key=>$v): ?><form class="form form-horizontal" enctype="multipart/form-data" action="<?php echo U('Headline/bianjis');?>" method="post" id="form-article-add">
		<div class="row cl">
