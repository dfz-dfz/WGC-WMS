...
<div class="page-container">
	<form action='/index.php/Admin/Designoffer/getList' method='post' id = 'qiandaosearch' name='qiandaosearch'>
	<div class="text-c">
...
function setjieshouren(id){
	var url = '/index.php/Admin/Designoffer/revlist/id/'+id+'';
	member_add('设置接受人',url,'','510');
}
//回复
/*function huifu(id){
	//http://jingyi.59jiaju.com/jingyi.php/Home/Weixiumsg/dataDetail
	var url = '/index.php/Admin/Designoffer/getDetail/id/'+id+'';
...
function huifu(id){
	...
	if(userids == null || userids == undefined || userids == ''){
		...
		var url = '/index.php/Admin/Designoffer/huifu/id/'+id+'/userid/'+userids+'';
		member_add('回复',url,'','610');
	}
}
//添加项目
...
function tianjiachuliren(id){
	var url = '/index.php/Admin/Weixiumsg/listtye/id/'+id+'';
