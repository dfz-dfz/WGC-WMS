...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
		...
		$('#fileware').live('change',function(){ 
			...
			$.ajax({ 
				url : '/index.php/Admin/Wangpanpc/uploadVideo', 
				type : 'POST', 
				data : formData, 
				// 告诉jQuery不要去处理发送的数据
				processData : false, 
					...
					if(responseStr.code == 200){
						var wenjian = "<div class='laosu' style='min-width:80px;min-height:80px;width:10%;text-align:center;padding:5px;float:left;position:relative;'>";
							if((responseStr.isdir == 2)){
								wenjian += "<img class='enterimg' src='/Public/admin/aui/image/6505/v8.ico' style='width:100%;' />";
							}
...
<div id='navi' style='width:100%;height:100%;padding:15px;overflow:auto;border:2px solid #C5C5C5;' >
	...
	<form id='documentuploads' action='/index.php/Admin/Wangpanpc/uploadVideo' method='post' enctype="multipart/form-data" >
...
<div>
	...
	<input type='hidden' id='ptypes' value='5' />
			   ...
			   function(data){
				 if(data.code == 200){
					...
					for(var o in msg){ 
						...
						if(msg[o].isdir == 2){
							wenjian2 += "<img class='enterimg' src='/Public/admin/aui/image/6505/v8.ico' style='width:100%;' />";
						}
