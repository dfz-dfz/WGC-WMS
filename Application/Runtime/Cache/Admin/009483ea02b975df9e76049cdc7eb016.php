...
<article class="page-container">
	...
	<form class="form form-horizontal" enctype="multipart/form-data" action="/index.php/Admin/Advertisement/addForms" method="post" id="form-article-add">
		<div class="row cl">
