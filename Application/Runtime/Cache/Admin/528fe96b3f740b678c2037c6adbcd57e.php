...
<div class="page-container">
	...
	<a class="btn btn-primary radius" data-title="添加广告" _href="/index.php/Admin/Advertisement/add/type/1" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加广告</a></span> <span class="r">共有数据：<strong><?php echo ($count); ?></strong> 条</span> </div>
	<div class="mt-20">
