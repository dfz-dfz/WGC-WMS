...
<article class="page-container">
       <?php if(is_array($bianji_cls)): foreach($bianji_cls as $key=>$v): ?><form class="form form-horizontal" enctype="multipart/form-data" action="<?php echo U('Headline/bianjis_cls');?>" method="post" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="<?php echo ($v['m_name']); ?>" class="input-text" name="m_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商店名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="<?php echo ($v['shopname']); ?>" class="input-text" name="shopname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商店地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="<?php echo ($v['shopaddress']); ?>" class="input-text" name="shopaddress">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="<?php echo ($v['price']); ?>" class="input-text" name="price">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>联系方式：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="<?php echo ($v['tel']); ?>" class="input-text" name="tel">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<span class="select-box">
					<select name="type" id="type" class="select" >
						<?php if(($_SESSION['wgcadmininfo']['kehu'] == '材料商')): ?><option value="57">产品推荐</option><?php endif; ?>
					 </select>
				</span> 
			</div>
		</div>
