 	...
 	<div class="container_right" style="width: 98%;border: 1px solid #cacaca;float: right;background-color: #f7f7f7;padding: 0 10px 10px 10px;">
		...
		<div class="budget base_ui_public" style="/*display: none;*/position: relative;">
			<ul class="budget_ul user_public_ul">
 				<li style="margin-right: 10px;">我的文档</li>
 				<li class="change_bg_li" style="margin-right: 10px;">图片</li>
			...
			<div class="sect current wages_custom" style="border: none;position: relative;overflow: hidden;min-height: 300px;height: auto;">
				...
				<div class="filelist">
					<!-- <div style="width: 20%;float: left;height: auto;overflow: hidden;">
					<img src="/themes/mall/jiaju/images/wenjiajia.png" alt="" style="width: 50%;height: 70px;"/>
					<span style="display: block;">我的资源</span>
					</div>
					 -->
					 <div class="filesmore">
				...
				<!-- <div class="nulls" style="font-size: 20px;color: #9e9e9e;width: 100%;text-align: center;margin-top:20px;">暂无列表</div> -->
			</div>
			<!-- 自定工价 end -->
		...
		$.ajax({
				...
				success:function(ret){
					...
					if(ret.code == 200){
						...
						$(".filelist .filesmore").html('<div class="nulls" style="font-size: 20px;color: #9e9e9e;width: 100%;text-align: center;margin-top:20px;">暂无列表</div>');
