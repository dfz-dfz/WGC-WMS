		...
		<form action="/index.php/Admin/Cailiaoshang/index" method="post">
			<span class="select-box inline">
				<select name="type" class="select">
					...
					<option value="2" <?php if($type == 2){echo "selected";}?>>材料名称</option>
					<option value="3" <?php if($type == 3){echo "selected";}?>>职务</option>
					<option value="4" <?php if($type == 4){echo "selected";}?>>电话号码</option>
				</select>
			</span>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr class="text-c"> 
						...
						<td><?php echo ($v['cailiaomingcheng']); ?></td>
						<td class="td-status"><?php echo ($v['cailiaopinpai']); ?></td>
						<td><?php echo ($v['cailiaomiansu']); ?></td>
						<td><?php echo ($v['cailiaodate']); ?></td>
						<td><?php echo ($v['cailiaoshuliang']); ?></td>
						<td><?php echo ($v['cailiaobeizhu']); ?></td>
						<td><?php echo (date('Y-m-d H:i:s',$v['addtime'])); ?></td>
						
						
						<td class="f-14 td-manage">
							<a style="text-decoration:none" onClick="article_edit('<?php echo ($v['cname']); ?>','/index.php/Admin/Cailiaoshang/cl_del/id/<?php echo ($v['id']); ?>','<?php echo ($v['id']); ?>')" href="javascript:;"><i class="Hui-iconfont" style="font-size:1.75rem" title="删除">&#xe6e2;</i></a>
						</td>
