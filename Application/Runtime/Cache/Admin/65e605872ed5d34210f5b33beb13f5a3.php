...
<div class="page-container">
	<div class="text-c">
		<?php if($_SESSION['wgcadmininfo']['fenxiaoshang_name'] == '' ): ?><a class="btn btn-primary radius" href="/index.php/Admin/User/userCate">全部</a>
			<a class="btn btn-primary radius" href="/index.php/Admin/User/userCate/type/1">百胜</a>
			<a class="btn btn-primary radius" href="/index.php/Admin/User/userCate/type/2">汉堡王</a>
			<a class="btn btn-primary radius" href="/index.php/Admin/User/userCate/type/3">麦当劳</a>
			<a class="btn btn-primary radius" href="/index.php/Admin/User/userCate/type/4">太平洋咖啡</a><?php endif; ?>
		 <form action="<?php echo U('User/index');?>" method="post" style="margin-top:20px;">
	...
	<span class="l">
		<?php if($wgcadmininfo['fenxiaoshang_name'] == '' ): ?><a class="btn btn-primary radius" data-title="添加成员" _href="/index.php/Admin/User/user_add" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加成员</a><?php endif; ?>
	</span> 
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr class="text-c">
						...
						<td><a href="<?php echo U('User/yue',array('user_id'=>$v['user_id']));?>"><?php echo ($v['balance']); ?>元</a></td>
						<td>
						<a href="<?php echo U('User/jifen',array('user_id'=>$v['user_id']));?>"><?php echo ($v['jifen']); ?>分</a>
						...
						<td class="f-14 td-manage">
							...
							<a style="text-decoration:none" href="<?php echo U('User/bianji_user',array('id'=>$v['user_id']));?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
							<a style="text-decoration:none" href="<?php echo U('User/password_user',array('id'=>$v['user_id']));?>" title="修改密码"><i class="Hui-iconfont">&#xe63f;</i></a>
							<?php if($_SESSION['wgcadmininfo']['fenxiaoshang_name'] == '' ): if($v['fenxiaoshang'] == 1): ?><a style="text-decoration:none" href="<?php echo U('User/bianji_fxs_quxiao',array('id'=>$v['user_id']));?>" title="取消分销商"><i class="Hui-iconfont">&#xe631;</i></a>
								<?php else: ?>
								
									<a style="text-decoration:none" href="<?php echo U('User/bianji_fxs',array('id'=>$v['user_id']));?>" title="设置为分销商"><i class="Hui-iconfont">&#xe6d3;</i></a><?php endif; endif; ?>
						</td>
...
function article_stop(obj,id){
	...
	layer.confirm('确认要取消推荐工人吗？',function(index){
		$.post("<?php echo U('User/pai');?>",{id:id,pai : 0}, function(data) {
			if(data.status == 1){
...
function article_start(obj,id){
	layer.confirm('确认要设置推荐工人吗？',function(index){
		$.post("<?php echo U('User/pai');?>",{id:id,pai : 1}, function(data) {
			if(data.status == 1){
