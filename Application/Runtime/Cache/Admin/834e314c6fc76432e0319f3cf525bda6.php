...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 维修项目 <span class="c-gray en">&gt;</span> 维修项目列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
function admin_del(prj_id){
	layer.confirm('确认要删除整个项目吗？',function(index){
		...
		window.location.href = '/index.php/Admin/Baojia/xiangmu_del/prj_id/'+prj_id;
