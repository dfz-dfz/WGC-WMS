...
//获取工种
function getJobtye($postion){
	$listArray = array('施工队长','水电工长','空调安装工长','空调安装工','泥水工','水电工','电焊工','家具安装工','木工','扇灰工','保洁工','杂工','设计师','预算员','其它','维修工','网络维修', '实习预结算员','室内设计师','工程经理','机电工程师','暖通设计师','采购经理','文案','平面设计','效果图设计师','客服专员','行政助理','软件销售经理','业务员','项目经理','水电维修','空调维修','装饰维修','设备维修','分销商','工匠','公司','材料商','前端开发','后端开发');
		
	return $listArray[$postion-1];
